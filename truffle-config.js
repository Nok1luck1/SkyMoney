  ...
  networks: {
    ...
    rinkeby: {
      provider: () =>
        new HDWalletProvider(
          mnemonic,
          `wss://rinkeby.infura.io/ws/v3/c0846c0936794c209285d51868f1ad77`
        ),
      network_id: 4, // Rinkeby's id
      production: false,
      networkCheckTimeout: 1000000,// gas:      10000000,
    ...
    goerli: {
      provider: () =>
        new HDWalletProvider(
          mnemonic,
          `https://goerli.infura.io/v3/39bf211ec4024c1ab7951c072b81d833`
        ),
